...
#' @param tax_level What are the direct levels 
#' @param threshold Threshold for when a trait is considered
retr_sets <- function(db, trait_vec, filt_term, id_col, tax_level, threshold = 0.95){
...
retr_sets(db = trait_db, 
          trait_vec = metabolic_sets, filt_term = "metabolism", 
